...
const documents = {
    "\n\tquery User {\n\t\tme {\n\t\t\tid\n\t\t\temail\n\t\t\tname\n\t\t\timage\n\t\t\temailVerified\n\t\t\tcreatedAt\n\t\t}\n\t}\n": types.UserDocument,
    "mutation CreateComment($animeId: String!, $message: String!) {\n    createComment(animeId: $animeId, message: $message) {\n      id\n                  message\n                  createdAt\n                  parentId\n                  viewerCanDelete\n                  viewerCanUpdate\n                  animeId\n    }\n  }": types.CreateCommentDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CreateComment($animeId: String!, $message: String!) {\n    createComment(animeId: $animeId, message: $message) {\n      id\n                  message\n                  createdAt\n                  parentId\n                  viewerCanDelete\n                  viewerCanUpdate\n                  animeId\n    }\n  }"): (typeof documents)["mutation CreateComment($animeId: String!, $message: String!) {\n    createComment(animeId: $animeId, message: $message) {\n      id\n                  message\n                  createdAt\n                  parentId\n                  viewerCanDelete\n                  viewerCanUpdate\n                  animeId\n    }\n  }"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tmutation changeAnimeStatusMutation($status: AnimeStatus!, $animeId: String!) {\n\t\tchangeStatusOfAnime(status: $status, animeId: $animeId)\n\t}\n"): (typeof documents)["\n\tmutation changeAnimeStatusMutation($status: AnimeStatus!, $animeId: String!) {\n\t\tchangeStatusOfAnime(status: $status, animeId: $animeId)\n\t}\n"];
