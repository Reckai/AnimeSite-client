...
export type GetCommentsByAnimeIdQuery = { __typename?: 'Query', getCommentsByAnimeId: Array<{ __typename?: 'Comment', id: string, message: string, createdAt: any, parentId?: string | null, viewerCanDelete: boolean, viewerCanUpdate: boolean, animeId: string, anime: { __typename?: 'Anime', slug: string }, user: { __typename?: 'User', id: string, name?: string | null, image?: string | null }, likes: Array<{ __typename?: 'Like', userId: string }> }> };
