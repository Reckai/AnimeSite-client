...
export type ChangeAnimeStatusMutationMutation = {
	__typename?: 'Mutation';
	changeStatusOfAnime: AnimeStatus;
};
...
export type DeleteAnimeFromWatchingListMutation = {
	__typename?: 'Mutation';
	deleteAnimeStatus: boolean;
};
...
export type OneAnimeQuery = {
	...
	anime: {
		...
		genres?: Array<{ __typename?: 'Genre'; id: string; name: string; russian: string }> | null;
		poster?: Array<{
			__typename?: 'Poster';
			originalUrl: string;
			id: string;
		...
		userWatchListStatusDistributions: Array<{
			__typename?: 'AnimeListStatusDistribution';
			status: AnimeStatus;
			count: number;
		}>;
		animeLists?: Array<{ __typename?: 'AnimeList'; id: string; status: AnimeStatus }> | null;
		studios?: Array<{ __typename?: 'Studio'; id: string; name: string }> | null;
	};
};
...
export type GetCommentsByAnimeIdQuery = {
	__typename?: 'Query';
	getCommentsByAnimeId: Array<{
		__typename?: 'Comment';
		id: string;
		message: string;
		createdAt: any;
		...
		isUserLikeComment: boolean;
		animeId: string;
		anime: { __typename?: 'Anime'; slug: string };
		user: { __typename?: 'User'; id: string; name?: string | null; image?: string | null };
		likes: Array<{ __typename?: 'Like'; userId: string }>;
	}>;
};
...
export type LoginWiaGoogleMutation = {
	__typename?: 'Mutation';
	loginWiaGoogle: {
		__typename?: 'User';
		id: string;
...
export type VerifyEmailByTokenMutation = {
	__typename?: 'Mutation';
	VerifyEmailByToken: { __typename?: 'VerifyEmailResponse'; message: string; success: boolean };
};
...
export type ItemsQuery = {
	...
	allAnimes: {
		...
		items: Array<{
			...
			genres?: Array<{ __typename?: 'Genre'; id: string; russian: string; name: string }> | null;
		}>;
	};
};
...
export type SignInMutationMutation = {
	__typename?: 'Mutation';
	loginUser: { __typename?: 'AuthPayload'; user: { __typename?: 'User'; id: string } };
};
...
export const ChangeAnimeStatusMutationDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'changeAnimeStatusMutation' },
			variableDefinitions: [
				{
					...
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'AnimeStatus' } }
					}
				},
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'animeId' } },
					type: {
						kind: 'NonNullType',
			...
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'changeStatusOfAnime' },
						arguments: [
							{
								kind: 'Argument',
							...
							},
							{
								...
								value: { kind: 'Variable', name: { kind: 'Name', value: 'animeId' } }
							}
						]
					}
				]
	...
	ChangeAnimeStatusMutationMutationVariables
>;
export const DeleteAnimeFromWatchingListDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'deleteAnimeFromWatchingList' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'animeId' } },
			...
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'deleteAnimeStatus' },
						arguments: [
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'animeId' },
	...
	DeleteAnimeFromWatchingListMutation,
	DeleteAnimeFromWatchingListMutationVariables
>;
export const OneAnimeDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'OneAnime' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
				...
				selections: [
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{ kind: 'Field', name: { kind: 'Name', value: 'licenseNameRu' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'description' } },
								{
									...
									selectionSet: {
										...
										selections: [
											{ kind: 'Field', name: { kind: 'Name', value: 'id' } },
											{ kind: 'Field', name: { kind: 'Name', value: 'name' } },
											{ kind: 'Field', name: { kind: 'Name', value: 'russian' } }
										]
									}
								},
								{
								...
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'userWatchListStatusDistributions' },
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
								...
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'animeLists' },
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{ kind: 'Field', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<OneAnimeQuery, OneAnimeQueryVariables>;
export const GetCommentsByAnimeIdDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'GetCommentsByAnimeId' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
				...
				selections: [
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{ kind: 'Field', name: { kind: 'Name', value: 'userCanDelete' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'userCanUpdate' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'isUserLikeComment' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'animeId' } },
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'anime' },
									selectionSet: {
...
} as unknown as DocumentNode<GetCommentsByAnimeIdQuery, GetCommentsByAnimeIdQueryVariables>;
...
} as unknown as DocumentNode<SignupUserMutation, SignupUserMutationVariables>;
export const LoginWiaGoogleDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'LoginWiaGoogle' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
...
} as unknown as DocumentNode<LoginWiaGoogleMutation, LoginWiaGoogleMutationVariables>;
export const VerifyEmailByTokenDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'VerifyEmailByToken' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'token' } },
...
} as unknown as DocumentNode<VerifyEmailByTokenMutation, VerifyEmailByTokenMutationVariables>;
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'allAnimes' },
						arguments: [
							{
								kind: 'Argument',
	...
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'signInMutation' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'args' } },
...
} as unknown as DocumentNode<SignInMutationMutation, SignInMutationMutationVariables>;
